...
```{r sample}
<<<<<<< HEAD #V: This is also a product of merging, HEAD is where the changes begin. 
...
=======
>>>>>>> b7b82fb30eb068d9fa220d7defd4ca08eb9a4798 #V: indicates where changes end for merging. 
```
